 ...
 */
public class TestFragment2 extends Fragment implements RecyclerViewClickInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        eventViewModel.getAllSDTEWeek().observe(getViewLifecycleOwner(), new Observer<List<SoftDateTimeEvent>>() {
        ...
        eventViewModel.getAllBDTEWeek().observe(getViewLifecycleOwner(), new Observer<List<BudgetDateTimeEvent>>() {
            @RequiresApi(api = Build.VERSION_CODES.N)
            @Override
        ...
        eventViewModel.getAllHDTEWeek().observe(getViewLifecycleOwner(), new Observer<List<HardDateTimeEvent>>() {
            @RequiresApi(api = Build.VERSION_CODES.N)
            @Override
